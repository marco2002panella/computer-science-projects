...
func (a *AppHandler) chatMembersHandle(w http.ResponseWriter, r *http.Request, token string, parts []string) {
	...
	query := r.URL.Query()
	isGroup := query.Get("isGroup") == "true"
	...
	members, err5 := database.GetChatMembers(a.DB, int64(chatid), isGroup)
	if err5 != nil {
